 ...
 */
package com.lmv.core.constants;

/**
 * Global class for all LmvCore constants. You can add global constants for your extension into this class.
 */
public final class LmvCoreConstants extends GeneratedLmvCoreConstants
{
	public static final String EXTENSIONNAME = "lmvcore";


	private LmvCoreConstants()
	{
		//empty
	}
