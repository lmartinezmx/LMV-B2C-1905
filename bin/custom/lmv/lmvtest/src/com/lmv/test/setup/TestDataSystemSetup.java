...
import com.lmv.test.constants.LmvTestConstants;
import com.lmv.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = LmvTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/lmvtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/lmvtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/lmvtest/import/cstickets.impex");
			...
			importImpexFile(context, "/lmvtest/import/csquotes.impex");
		}
	}
}
