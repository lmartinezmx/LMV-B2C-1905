...
import com.lmv.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link com.lmv.fulfilmentprocess.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
