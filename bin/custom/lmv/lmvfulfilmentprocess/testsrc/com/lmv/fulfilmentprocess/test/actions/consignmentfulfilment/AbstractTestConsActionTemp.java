 ...
 */
package com.lmv.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, LmvFulfilmentProcessConstants.PARENT_PROCESS);
