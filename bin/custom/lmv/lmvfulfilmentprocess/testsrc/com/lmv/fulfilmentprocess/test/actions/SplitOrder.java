 ...
 */
package com.lmv.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(LmvFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(LmvFulfilmentProcessConstants.PARENT_PROCESS);
