 ...
 */
package com.lmv.storefront.controllers.pages;
...
import com.lmv.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException // NOSONAR
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("lmvstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("lmvstorefront.quick.order.rows.max", 25)));
