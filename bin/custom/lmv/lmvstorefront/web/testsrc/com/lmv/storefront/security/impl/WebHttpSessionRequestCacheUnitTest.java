...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/lmvstorefront/electronics/en",
						"https://electronics.local:9002/lmvstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/lmvstorefront/electronics/en",
						"https://electronics.local:9002/lmvstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/lmvstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/lmvstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/lmvstorefront/electronics/en",
						"https://electronics.local:9002/lmvstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/lmvstorefront",
						"https://electronics.local:9002/lmvstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/lmvstorefront",
						"https://electronics.local:9002/lmvstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/lmvstorefront/electronics/en",
						"https://electronics.local:9002/lmvstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
